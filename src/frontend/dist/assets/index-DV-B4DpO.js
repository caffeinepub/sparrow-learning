...
function makeMcq(word, meaning, allVocab) {
  const wrong = allVocab.filter((v) => v[0] !== word).sort(() => Math.random() - 0.5).slice(0, 3).map((v) => v[1]);
...
function makeFill(word, meaning, pronunciation) {
  return {
    type: "fill",
...
function makeTranslate(word, meaning) {
  return {
    type: "translate",
    source: meaning,
    answer: word,
...
function getLevels(language) {
  ...
  const units = language === "japanese" ? japaneseUnits : language === "mandarin" ? mandarinUnits : kannadaUnits;
  const levels = [];
  let levelId = 1;
  for (let unitIdx = 0; unitIdx < 50; unitIdx++) {
    const unit = units[unitIdx % units.length];
    const unitNumber = unitIdx + 1;
    const unitTitle = unitIdx < units.length ? unit.title : `${unit.title} — Advanced ${Math.floor(unitIdx / units.length) + 1}`;
...
const MAX_HEARTS = 5;
const HEART_REGEN_MS = 30 * 60 * 1e3;
...
function regenHearts(p) {
  if (p.hearts >= MAX_HEARTS) return p;
  const now2 = Date.now();
  const elapsed = now2 - (p.lastHeartTime || now2);
  ...
  if (heartsToAdd > 0) {
    ...
    return {
      ...p,
      hearts: newHearts,
      lastHeartTime: newHearts >= MAX_HEARTS ? 0 : now2 - elapsed % HEART_REGEN_MS
    };
  }
  return p;
}
...
function completeLevel(lang, levelId, xpEarned) {
  const p = getProgress(lang);
...
function addMistake(lang, entry) {
  const p = getProgress(lang);
  const mistake = {
    ...entry,
    language: lang,
...
function ExerciseEngine({
  ...
  const [showNoHearts, setShowNoHearts] = reactExports.useState(false);
  const [selectedLeft, setSelectedLeft] = reactExports.useState(null);
  const [matchedPairs, setMatchedPairs] = reactExports.useState([]);
  const [wrongMatch, setWrongMatch] = reactExports.useState(null);
  const [inputValue, setInputValue] = reactExports.useState("");
  const [vocabRevealed, setVocabRevealed] = reactExports.useState(false);
  const [mcqSelected, setMcqSelected] = reactExports.useState(null);
  const [mcqConfirmed, setMcqConfirmed] = reactExports.useState(false);
  ...
  const textPrimary = darkMode ? "oklch(0.95 0.01 280)" : "oklch(0.15 0.04 280)";
  const textMuted = darkMode ? "oklch(0.62 0.06 280)" : "oklch(0.55 0.06 280)";
  const borderColor = darkMode ? "oklch(0.28 0.06 280)" : "oklch(0.88 0.04 280)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        confetti.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
            ...
            children: confetti.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    flex: 1,
                    height: 10,
                    background: darkMode ? "oklch(0.25 0.06 280)" : "oklch(0.90 0.03 280)",
                    borderRadius: 999,
                    overflow: "hidden"
                  },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        height: "100%",
                        background: "linear-gradient(90deg, oklch(0.55 0.22 280), oklch(0.65 0.18 280))",
                        borderRadius: 999,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 3 }, children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    fontSize: "1.1rem",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    currentExercise.type === "vocab" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      VocabExercise,
                      {
                    ...
                    currentExercise.type === "mcq" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      McqExercise,
                      {
                        exercise: currentExercise,
                    ...
                    currentExercise.type === "fill" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FillExercise,
                      {
                        exercise: currentExercise,
                        value: inputValue,
                        ...
                        onSubmit: () => {
                          const correct = inputValue.trim().toLowerCase() === currentExercise.answer.toLowerCase();
                    ...
                    currentExercise.type === "match" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      MatchExercise,
                      {
                        exercise: currentExercise,
                        selectedLeft,
                        ...
                        onSelectRight: (t) => {
                          ...
                          const correctTranslation = (_a2 = currentExercise.pairs.find(
                            (p) => p.word === selectedLeft
                          )) == null ? void 0 : _a2.translation;
                    ...
                    currentExercise.type === "translate" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      TranslateExercise,
                      {
                        exercise: currentExercise,
                        value: inputValue,
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 64, marginBottom: "0.5rem" }, children: "🎉" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h2",
                    {
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: textMuted, marginBottom: "1rem" }, children: level.levelTitle }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        background: darkMode ? "oklch(0.22 0.06 280)" : "oklch(0.96 0.02 280)",
                        borderRadius: "0.75rem",
                        padding: "0.75rem",
                        marginBottom: "1.5rem"
                      },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      onClick: onComplete,
                      style: {
                        background: "linear-gradient(135deg, oklch(0.50 0.22 280), oklch(0.60 0.18 260))",
                        color: "white",
                        border: "none",
                        borderRadius: "0.75rem",
        ...
        showNoHearts && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 56, marginBottom: "0.5rem" }, children: "💔" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h2",
                    {
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Hearts regenerate 1 every 30 minutes. Come back later or keep practicing!"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
...
function VocabExercise({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: textMuted, fontSize: "0.9rem", marginBottom: "1rem" }, children: "New Word" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: exercise.word
      }
    ),
    exercise.pronunciation && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          fontSize: "1rem",
...
function FillExercise({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: textMuted, fontSize: "0.9rem", marginBottom: "1rem" }, children: "Fill in the blank" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        style: {
          ...
          background: darkMode ? "oklch(0.22 0.06 280)" : "oklch(0.97 0.01 280)",
          color: textPrimary,
          fontSize: "1.05rem",
          marginBottom: "1rem",
          outline: "none",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        disabled: !value.trim(),
        style: {
          background: value.trim() ? "linear-gradient(135deg, oklch(0.50 0.22 280), oklch(0.60 0.18 260))" : "oklch(0.60 0.04 280)",
          color: "white",
          border: "none",
          borderRadius: "0.75rem",
          padding: "0.85rem",
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      background: isMatched ? "oklch(0.62 0.18 145 / 0.15)" : isSelected ? "oklch(0.65 0.18 280 / 0.15)" : isWrong ? "oklch(0.58 0.22 25 / 0.1)" : darkMode ? "oklch(0.22 0.06 280)" : "oklch(0.95 0.02 280)",
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      background: isMatched ? "oklch(0.62 0.18 145 / 0.15)" : darkMode ? "oklch(0.22 0.06 280)" : "oklch(0.95 0.02 280)",
                      color: isMatched ? "oklch(0.45 0.18 145)" : textPrimary,
                      fontWeight: 600,
                      fontSize: "0.85rem",
                      cursor: isMatched ? "default" : "pointer",
...
function TranslateExercise({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: textMuted, fontSize: "0.9rem", marginBottom: "1rem" }, children: "Translate this phrase" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
...
function IntroScreen({ onSelectLanguage }) {
  const [hovered, setHovered] = reactExports.useState(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-hero min-h-screen flex flex-col items-center justify-center px-4 py-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center max-w-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-bounce-in mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 72, lineHeight: 1 }, children: "🐦" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h1",
        {
          className: "animate-slide-up",
          style: {
            ...
            background: "linear-gradient(135deg, oklch(0.95 0.04 280), oklch(0.78 0.18 75), oklch(0.68 0.18 25))",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            backgroundClip: "text",
            marginBottom: "0.5rem"
          },
          children: "Sparrow Learning"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "p",
        {
          ...
          children: [
            "Learn any language, one tiny step at a time. ✨",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.95rem", color: "oklch(0.65 0.04 280)" }, children: "500 levels · 3 languages · Progress at your own pace" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: Object.entries(LANGUAGE_INFO).map(([lang, info]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          style: {
            background: hovered === lang ? "oklch(0.55 0.22 280)" : "oklch(0.22 0.08 280)",
            ...
            cursor: "pointer",
            transition: "all 0.2s ease",
            transform: hovered === lang ? "translateY(-4px) scale(1.04)" : "none",
            boxShadow: hovered === lang ? "0 12px 32px oklch(0.45 0.22 280 / 0.4)" : "0 4px 16px oklch(0 0 0 / 0.3)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 40, marginBottom: 8 }, children: info.flag }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 700, fontSize: "1.1rem" }, children: info.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "No account needed · All progress saved locally"
        }
      )
    ] })
  ] });
...
function LevelMap({
  ...
  const currentRef = reactExports.useRef(null);
  ...
  reactExports.useEffect(() => {
    setTimeout(() => {
      var _a2;
      (_a2 = currentRef.current) == null ? void 0 : _a2.scrollIntoView({
        behavior: "smooth",
        block: "center"
      });
    }, 300);
  }, []);
  const isCompleted = (id) => progress.completedLevels.includes(id);
  const isCurrent = (id) => id === progress.currentLevel;
  const isUnlocked = (id) => id <= progress.currentLevel;
  const levelsByUnit = levels.reduce(
    (acc, level) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              top: 0,
              zIndex: 50,
              background: darkMode ? "oklch(0.15 0.05 280 / 0.95)" : "oklch(0.99 0.01 280 / 0.95)",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 28 }, children: info.flag }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            fontWeight: 700,
                            fontSize: "1rem",
                            color: darkMode ? "oklch(0.92 0.02 280)" : "oklch(0.2 0.06 280)"
                          },
                          children: info.name
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          style: {
                            fontSize: "0.75rem",
                            color: darkMode ? "oklch(0.62 0.06 280)" : "oklch(0.55 0.06 280)"
                          },
                          children: [
                            "Level ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0.75rem", alignItems: "center" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  StatChip,
                  {
                    icon: "⚡",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(HeartsChip, { hearts: progress.hearts, dark: darkMode })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            children: [
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          style: {
                            ...
                            background: allComplete ? "linear-gradient(135deg, oklch(0.78 0.18 75), oklch(0.68 0.18 25))" : darkMode ? "oklch(0.22 0.08 280)" : "oklch(0.90 0.04 280)",
                            color: allComplete ? "oklch(0.15 0.04 280)" : darkMode ? "oklch(0.78 0.08 280)" : "oklch(0.40 0.12 280)",
                            borderRadius: "999px",
                            padding: "0.45rem 1.25rem",
                            fontWeight: 700,
                            fontSize: "0.85rem",
                            letterSpacing: "0.03em",
                            boxShadow: allComplete ? "0 4px 16px oklch(0.78 0.18 75 / 0.35)" : "none"
                          },
                          children: [
                            allComplete ? "✓ " : "",
                            "Unit ",
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "button",
                                {
                                  ...
                                  style: {
                                    ...
                                    transition: "all 0.2s ease",
                                    position: "relative",
                                    background: completed ? "linear-gradient(135deg, oklch(0.78 0.18 75), oklch(0.72 0.16 55))" : current ? "oklch(0.50 0.22 280)" : unlocked ? darkMode ? "oklch(0.28 0.10 280)" : "oklch(0.88 0.06 280)" : darkMode ? "oklch(0.20 0.04 280)" : "oklch(0.90 0.02 280)",
                                    color: completed ? "oklch(0.15 0.04 280)" : current ? "white" : unlocked ? darkMode ? "oklch(0.82 0.06 280)" : "oklch(0.35 0.12 280)" : darkMode ? "oklch(0.45 0.04 280)" : "oklch(0.72 0.04 280)",
                                    boxShadow: current ? "0 0 0 4px oklch(0.65 0.18 280 / 0.4), 0 6px 24px oklch(0.45 0.22 280 / 0.5)" : completed ? "0 4px 16px oklch(0.78 0.18 75 / 0.4)" : "none",
                                    animation: current ? "pulse-glow 2s ease-in-out infinite" : "none"
                                  },
                                  children: completed ? "★" : current ? "☆" : unlocked ? level.id : "🔒"
                                }
                              ),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  style: {
                                    fontSize: "0.7rem",
                                    fontWeight: 600,
                                    color: current ? "oklch(0.65 0.18 280)" : completed ? "oklch(0.72 0.14 75)" : darkMode ? "oklch(0.55 0.04 280)" : "oklch(0.60 0.06 280)",
                                    textAlign: "center",
                                    maxWidth: 80
                                  },
                                  children: level.levelTitle
                                }
                              )
                            ]
                          }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "🏆 Keep going! You\\'re building something great."
                }
              )
            ]
          }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color, fontSize: "0.9rem" }, children: value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
...
function HeartsChip({ hearts }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 3 }, children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
...
function App() {
  const [screen, setScreen] = reactExports.useState("intro");
  const [language, setLanguage] = reactExports.useState("japanese");
  const [activeLevelId, setActiveLevelId] = reactExports.useState(1);
  const [darkMode, setDark] = reactExports.useState(() => getDarkMode());
  const [mapRefresh, setMapRefresh] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  if (screen === "intro") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(IntroScreen, { onSelectLanguage: handleSelectLanguage });
  }
  if (screen === "map") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      LevelMap,
...
field ${k} -> ${e.message}`);
  ...
  encodeValue(x) {
    const values = this._fields.map(([key2]) => x[key2]);
  ...
  _buildTypeTableImpl(T) {
    ...
    const fields = this._fields.map(([key2, value]) => concat(lebEncode(idlLabelToId(key2)), value.encodeType(T)));
...
variant ${k} -> ${e.message}`);
  ...
  _buildTypeTableImpl(typeTable) {
    ...
    const len = lebEncode(this._fields.length);
    const fields = this._fields.map(([key2, value]) => concat(lebEncode(idlLabelToId(key2)), value.encodeType(typeTable)));
...
const _Ed25519PublicKey = class _Ed25519PublicKey {
  ...
  constructor(key2) {
    ...
    __privateSet(this, _derKey, _Ed25519PublicKey.derEncode(key2));
  }
  /**
  ...
  static from(maybeKey) {
    if (typeof maybeKey === "string") {
      const key2 = hexToBytes(maybeKey);
...
class AuthClient {
  ...
  static async create(options = {}) {
      ...
      try {
        ...
        if (options.identity) {
          ...
          if (!isDelegationValid(chain)) {
            ...
            if ("toDer" in key2) {
              identity = PartialDelegationIdentity.fromDelegation(key2, chain);
            } else {
              identity = DelegationIdentity.fromDelegation(key2, chain);
            }
          }
        }
      } catch (e) {
    ...
    return new this(identity, key2, chain, storage, idleManager, options);
  }
